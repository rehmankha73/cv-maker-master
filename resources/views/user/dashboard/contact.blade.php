    ...
    <section class="mb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-9 mb-md-0 mb-5">
                <form  action="{{url('/user/dashboard/contact')}}" method="POST">
                    @csrf
                    <!--Grid row-->
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="md-form mb-0">
                                ...
                                <input type="text" id="name" name="name" class="form-control" value="{{auth('web')->user()->first_name}} {{auth('web')->user()->last_name}}">
                            </div>
                        </div>
                        <!--Grid column-->
                        ...
                        <div class="col-md-6">
                            <div class="md-form mb-0">
                                ...
                                <input type="text" id="email" name="email" class="form-control" value="{{auth('web')->user()->email}}">
                            </div>
                        </div>
                        <!--Grid column-->
                    </div>
