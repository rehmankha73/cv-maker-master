...
@section('content')
<h1><i class="fas fa-plus-circle"></i> &nbsp;Add Job Posts</h1>
    <hr>
    ...
    <form method="POST" action="{{route('admin.posts.store')}}" enctype="multipart/form-data">
        ...
        <section class="container py-2 px-5 bg-white" >
            <div class="row">
                <label class="col-md-3">Add Title<span class="text-danger">*</span></label>
            ...
            <br>
            <div class="row">
                <label class="col-md-3">Add Location<span class="text-danger">*</span></label>
            ...
            <div class="row my-1" >
                <div class="col-md-6">
                    <div class="row">
                        <label class="col-md-12">Required career level for job?<span class="text-danger">*</span></label>
                        <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <label class="col-md-12">No. of Positions?<span class="text-danger">*</span></label>
                        <div class="col-md-12">
            ...
            <div class="row my-1">
                <label class="col">
                    What minimium qualifications is required?<span class="text-danger">*</span>
                </label>
                <div class="col-md-12">
            ...
            <div class="row my-1">
                <label class="col">
                    year of experience required?<span class="text-danger">*</span>
                </label>
                <div class="col-md-12">
                    <select class="p-1" name="experiences">
                        <option >Chosse year of experiences</option>
                        <option >1</option>
                        <option >2</option>
                        <option >3</option>
                        <option >4</option>
            ...
            <div class="row my-1">
                <label class="col-md-12">
                    range of salary required?(optional)
                </label>
                <div class="col-md-6">
