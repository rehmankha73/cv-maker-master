...
<head>
    ...
    <link href="{{url('design-assets/css/sb-admin-2.css')}}" rel="stylesheet">
    <style>
        .image
        {
            background-image: url("../images/company/m4.jpg");
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block image">
                            {{--                            <img src="{{url('/images/company/cp3.png')}}">--}}
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-5 ">Welcome to Admin Panel!</h1>
                                </div>
                                <form method="POST" action="{{ route('admin.login') }}">
                                @csrf
                                    <div class="form-group">
                                        <input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter Emial">
                                        @error('email')
