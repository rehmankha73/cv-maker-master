...
<header>
    <nav class="navbar navbar-expand-md navbar-light navbar-inverse fixed-top cvNav" style="">
        <a class="navbar-brand ml-3" href="{{url('/')}}"><img src="/images/main/logo.png" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/jobs')}}">Jobs Portal</a>
                </li>
                @auth('company')
                    <li class="nav-item">
        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade cvCarousel" data-ride="carousel">
            ...
            <div class="carousel-inner myinner">
                <div class="carousel-item darkOverlay active">
                    <img class="banner d-block w-100" src="/images/company/cp1.png" alt="First slide">
                    <div class="carousel-caption">
                        <h2>Passionate <span>Employees</span></h2>
                        <h3>For You</h3>
                        <p><a class="btnSlider" href="{{route('company.jobpost.create')}}">Post A Job</a></p>
                    </div>
                </div>
                <div class="carousel-item darkOverlay">
                    <img class="banner d-block w-100" src="/images/company/cp2.png" alt="Second slide">
                    <div class="carousel-caption">
                        <h2>Find <span>Required</span></h2>
                        <p>Employees</p>
                        <p><a class="btnSlider" href="{{route('company.jobpost.create')}}">Post A Job</a></p>
                    </div>
                </div>
                <div class="carousel-item darkOverlay">
                    <img class="banner d-block w-100" src="/images/company/cp3.png" alt="Third slide">
                    <div class="carousel-caption">
                        <h2>Suitable <span>Employees</span></h2>
                        <p>For Your Job</p>
                        <p><a class="btnSlider" href="{{route('company.jobpost.create')}}">Post A Job</a></p>
                    </div>
                </div>
                <div class="carousel-item darkOverlay">
                    <img class="banner d-block w-100" src="/images/company/cp4.png" alt="Third slide">
                    <div class="carousel-caption">
                        <h2>Suitable <span>Employees</span></h2>
                        <p>For Your Job</p>
                        <p><a class="btnSlider" href="{{route('company.jobpost.create')}}">Post A Job</a></p>
                ...
                <div class="carousel-item darkOverlay">
                    <img class="banner d-block w-100" src="/images/company/cp5.png" alt="Third slide">
                    <div class="carousel-caption">
                        <h2>Choose <span>Better</span></h2>
                        <p>Employees</p>
                        <p><a class="btnSlider" href="">Explore Employees</a></p>
                    </div>
                </div>
            </div>
