...
<head>
    ...
    <style>
        .image
        {
            background-image: url("../images/company/cp5.png");
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-5 ">Welcome Company Login!</h1>
                                </div>
                                <form method="POST" action="{{ route('company.login') }}" class="user mt-5" >
                                @csrf
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="small btn btn-link" href="{{ route('company.password.request') }}">
