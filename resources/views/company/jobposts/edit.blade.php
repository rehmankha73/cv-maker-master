...
@section('centermain')
    <h1 id="heading" class="mb-5"><i class="fas fa-edit mr-3"></i>Edit Posts</h1>
    <a class="text-success" href="{{url('/company/dashboard/posts')}}">back</a>
    <hr>
    @include('layouts.errors')
    <form action="{{route('company.jobpost.update', [$posts->id])}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label">Post Title<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
                <input type="text" class="form-control" id="inputEmail3" name="title" value="{{$posts->title}}">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label ">Feature Image<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label ">Location<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label ">Level of Experience<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
{{--                <input type="text" class="form-control" name="career" value="{{$posts->career}}">--}}
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label">No of Position<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
{{--                <input type="text" class="form-control" name="positions" value="{{$posts->positions}}">--}}
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label ">What is minimum qualification is required?<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
{{--                <input type="text" class="form-control" name="qualifications" value="{{$posts->qualifications}}">--}}
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-md-3 col-form-label ">Experience is required?<span class="text-danger"><b>*</b></span></label>
            <div class="col-md-9">
